    ...
    <main className="min-h-screen bg-[#07090c] text-white">
      ...
      <header className="relative pt-44 pb-32 px-6 sm:px-12 border-b border-white/5">
        <div className="max-w-4xl mx-auto relative z-10">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-white/40 hover:text-white mb-12 transition-colors font-mono text-[10px] uppercase tracking-widest"
          >
      ...
      <article className="py-24 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="prose prose-invert prose-lg max-w-none prose-headings:font-black prose-headings:italic prose-headings:uppercase prose-headings:tracking-tighter prose-a:text-[#FF3B00]" style={{ fontFamily: 'Georgia, serif' }}>
            <div className="whitespace-pre-line text-xl md:text-2xl text-white/70 leading-[1.7] italic">{post.content}</div>
          </motion.div>
