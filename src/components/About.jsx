...
export default function About() {
    ...
    return (
      <section className="min-h-screen bg-white text-black py-20 px-6 sm:px-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black/60 font-mono text-xs tracking-widest uppercase">Initializing Bio...</p>
        </div>
      </section>
    );
  }
  ...
  if (!about) {
    return (
      <section className="min-h-screen bg-white text-black py-20 px-6 sm:px-12 flex items-center justify-center">
        <div className="text-center">
          <p className="text-xl text-black/40 font-mono tracking-widest">NO_BIOGRAPHY_DEFINED</p>
        </div>
      </section>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 right-10 opacity-[0.03] pointer-events-none select-none">
        <h2 className="text-[12rem] font-black uppercase leading-none tracking-tighter">BIO</h2>
      </div>
          ...
          <div className="lg:col-span-5 relative group">
            ...
            >
              ...
              <p className="text-[11px] font-mono leading-relaxed text-black/60 italic">
                Currently refining the boundaries between <span className="text-black font-bold">Digital Excellence</span> and <span className="text-black font-bold">Human Intuition</span>.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7 pt-12 md:pt-0">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-16 border-t border-black/5">
                {[
                  { label: "Direct Inquiries", value: about.email, folio: "01" },
                  { label: "Base of Operations", value: about.location, folio: "02" },
            ...
            >
              ...
              <div className="flex items-center gap-4 text-black/20">
                ...
                <span className="text-[9px] font-mono tracking-[0.4em] uppercase font-bold">END_OF_RECORD</span>
              </div>
            </motion.div>
          </div>
        </div>
